...
from .vlm_parquet_dataset import VLMParquetLVRIterableDataset


DATASET_REGISTRY = {
    't2i_pretrain': T2IIterableDataset,
    'vlm_sft': SftJSONLIterableDataset,
    'vlm_sft_parquet': VLMParquetLVRIterableDataset,
...
DATASET_INFO = {
    ...
    'vlm_sft_parquet': {
        'viscot_lvr': {
            'data_dir': '/hpc2hdd/home/fzhai598/project/Bagel/Visual-CoT/viscot_parquet',
            'num_files': 809,
            'num_total_samples': 404119,
            'parquet_info_path': '/hpc2hdd/home/fzhai598/project/Bagel/Visual-CoT/viscot_parquet_info/viscot_lvr_info.json',
        },
    },
}